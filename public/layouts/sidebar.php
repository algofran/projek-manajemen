    ...
    <div class="sidebar-inner slimscroll">
        <div id="sidebar-menu" class="sidebar-menu">
            <ul>
                ...
                <li>
                    <a href="index.php?page=dashboard"><i class="feather-grid"></i><span>Dashboard</span></a>
                </li>
                <li class="submenu">
                ...
                <li>
                    <a href="index.php?page=telkom_akses"><i class="feather-codepen"></i><span>Telkom Akses</span></a>
                </li>
                <li class="submenu">
