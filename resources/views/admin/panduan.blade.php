...
<div class="div">
    <div class="row">
        ...
        <div class="col-md-3 text-md-end">
            <a href="{{ route('guide.add') }}" class="btn btn-primary btn-blog mb-3"><i class="feather-plus-circle me-1"></i> Add New</a>
        </div>
    </div>
    <div class="row">
        ...
        <div class="col-md-6 col-xl-4 col-sm-12 d-flex">
            <div class="blog grid-blog flex-fill">
                <div class="blog-image">
                    <a href="{{ route('guide.detail', ['id' => $item->id]) }}"><img class="img-fluid" src="data:image/jpeg;base64,{{ $item->image }}" alt="Post Image" style="width: 100%; height: 200px;"></a>
                </div>
                <div class="blog-content">
                    <ul class="entry-meta meta-item">
                        <li>
                            <div class="post-author">
                                <a href="{{ route('guide.detail', ['id' => $item->id]) }}">
