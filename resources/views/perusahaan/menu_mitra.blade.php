                ...
                <div class="col-12 col-lg-6 col-xl-6">
                    <div class="card flex-fill">
                        <div class="card-header">
                            ...
                            <div class="mt-3 d-grid gap-2 mx-auto">
                                    <a href="{{ route('keuangan',['id' => $item])}}" class="btn btn-outline-danger mx-4">+ KLIK</a>
                            </div>
                        </div>
                        <div class="card-body text-center">
                        </div>
                ...
                <div class="col-12 col-lg-6 col-xl-6">
                  <div class="card flex-fill">
                      <div class="card-header">
                          ...
                          <div class="mt-3 d-grid gap-2 mx-auto">
                                  <a href="{{ route('_laporan.tahun.perusahaan',['id' => $item])}}" class="btn btn-outline-danger mx-4">+ KLIK</a>
                          </div>
                      </div>
                      <div class="card-body text-center">
                      </div>
