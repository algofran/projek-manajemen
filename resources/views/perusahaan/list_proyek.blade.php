                ...
                <div class="page-header">
                    <div class="row align-items-center">
                        <div class="col-auto text-end float-end ms-auto download-grp">
                            ...
                            <a href="{{ route('add.proyek', ['id' => $mitra->id]) }}" data-bs-toggle="modal" data-bs-target="#bank_details" class="btn btn-outline-danger"><i class="fas fa-plus"></i> Tambah Projek</a>
                        </div>
                    </div>
                                        ...
                                        <form action="{{ route('update', $item->id) }}" method="post">
                                            ...
                                            <div class="modal-body">
                                                ...
                                                <div class="form-group row">
                                                    ...
                                                    <div class="col-md-10">
                                                        <input type="text" class="form-control @error('periode') is-invalid @enderror" placeholder="Periode (Contoh : JANUARI 2024)..." value="{{ old('periode',$item->periode) }}" name="periode">
                                                        @error('periode')
                                                ...
                                                <div class="form-group row">
                                                    ...
                                                    <div class="col-md-10">
                                                        <input type="text" name="sektor" class="form-control @error('sektor') is-invalid @enderror" value="{{ old('sektor', $item->sektor) }}" placeholder="Sektor/Area...">
                                                        @error('sektor')
                                                            <span class="invalid-feedback" role="alert">
                                                                <strong>{{ $message }}</strong>
                                                            </span>
                                                ...
                                                <div class="form-group row">
                                                    ...
                                                    <div class="col-md-10">
                                                        <input type="text" name="PA" class="form-control @error('PA') is-invalid @enderror" value="{{ old('PA', $item->PA) }}" placeholder="Jumlah Aktivasi (PA)...">
                                                        @error('PA')
                                                            <span class="invalid-feedback" role="alert">
                                                                <strong>{{ $message }}</strong>
                                                            </span>
                                                ...
                                                <div class="form-group row">
                                                    ...
                                                    <div class="col-md-10">
                                                        <input type="text" name="keterangan" class="form-control @error('keterangan') is-invalid @enderror" value="{{ old('keterangan', $item->keterangan) }}" placeholder="Keterangan...">
                                                        @error('keterangan')
                                                            <span class="invalid-feedback" role="alert">
                                                                <strong>{{ $message }}</strong>
                                                            </span>
                                                ...
                                                <div class="form-group row">
                                                    ...
                                                    <div class="col-md-10">
                                                        <input type="number" class="form-control @error('tagihan') is-invalid @enderror" placeholder="Jumlah tagihan..." name="tagihan" value="{{ old('tagihan', $item->tagihan) }}">
                                                        @error('tagihan')
                                                            <span class="invalid-feedback" role="alert">
                                                                <strong>{{ $message }}</strong>
                                                            </span>
                                                ...
                                                <div class="form-group row">
                                                    ...
                                                    <div class="col-md-10">
                                                        <input type="date" class="form-control @error('start_date') is-invalid @enderror" name="start_date" value="{{ old('start_date', $item->start_date) }}">
                                                        @error('start_date')
                                                            <span class="invalid-feedback" role="alert">
                                                                <strong>{{ $message }}</strong>
                                                            </span>
                                                ...
                                                <div class="form-group row">
                                                    ...
                                                    <div class="col-md-10">
                                                        <input type="date" class="form-control @error('end_date') is-invalid @enderror" name="end_date" value="{{ old('end_date', $item->end_date) }}">
                                                        @error('end_date')
                                                            <span class="invalid-feedback" role="alert">
                                                                <strong>{{ $message }}</strong>
                                                            </span>
                                                ...
                                                <div class="form-group row">
                                                    ...
                                                    <div class="col-md-10">
                                                        <select class="form-control form-select @error('payment') is-invalid @enderror" name="payment">
                                                ...
                                                <div class="form-group row">
                                                    ...
                                                    <div class="col-md-10">
                                                        <div class="border">
                                                            ...
                                                            @endphp
                                                            <select class="form-control form-select @error('bank') is-invalid @enderror" name="bank">
                                                                @foreach($bank as $option)
                                                                    <option value="{{ $option }}" {{ old('bank', $item->bank) == $option ? 'selected' : '' }}>{{ $option }}</option>
                                                                @endforeach
                                                            </select>
                                                            @error('bank')
                                                                <span class="invalid-feedback" role="alert">
                                                ...
                                                <div class="form-group row">
                                                    ...
                                                    <div class="col-md-10">
                                                        <select class="form-control form-select @error('manager_id') is-invalid @enderror" name="manager_id">
                    ...
                    <form action="{{ route('add.store') }}" method="post">
                        ...
                        <div class="modal-body">
                            ...
                            <div class="form-group row">
                                <label class="col-form-label col-md-2">Periode</label>
                                <div class="col-md-10">
                                    <input type="text" name="periode" class="form-control @error('periode') is-invalid @enderror" value="{{ old('periode') }}" placeholder="Periode (Contoh : JANUARI 2024)..." >
                                    @error('periode')
                            ...
                            <div class="form-group row">
                                <label class="col-form-label col-md-2">Sektor</label>
                                <div class="col-md-10">
                                    <input type="text" name="sektor" class="form-control @error('sektor') is-invalid @enderror" value="{{ old('sektor') }}" placeholder="Sektor/Area" >
                                    @error('sektor')
                                        <span class="text-danger">{{ $message }}</span>
                                    @enderror
                                </div>
                            ...
                            <div class="form-group row">
                                <label class="col-form-label col-md-2">Jumlah PA</label>
                                <div class="col-md-10">
                                    <input type="text" name="PA" class="form-control @error('PA') is-invalid @enderror" value="{{ old('PA') }}" placeholder="Jumlah Aktivasi (PA)..." >
                                    @error('PA')
                                        <span class="text-danger">{{ $message }}</span>
                                    @enderror
                                </div>
                            ...
                            <div class="form-group row">
                                <label class="col-form-label col-md-2">Start Date</label>
                                <div class="col-md-10">
                                    <input type="date" name="start_date" class="form-control @error('start_date') is-invalid @enderror" value="{{ old('start_date', now()->format('Y-m-d')) }}" >
                                    @error('start_date')
                                        <span class="text-danger">{{ $message }}</span>
                                    @enderror
                                </div>
