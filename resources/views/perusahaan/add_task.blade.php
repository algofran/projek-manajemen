                ...
                <div class="card">
                    <div class="page-header container py-3 bg-danger bg-gradient text-white rounded">
                        <div class="row align-items-center">
                            <div class="col">
                                <p class="fw-bolder fs-6 text-white my-auto">Tambah Tugas</p>
                                <ul class="breadcrumb">
                                    ...
                                    <li class="breadcrumb-item text-white">Tambah Tugas</li>
                                </ul>
                            </div> 
                        </div>
                    </div>
                    <div class="card-body">
                        <form action="{{ route('_store.task') }}" method="post">
                            @csrf
                            <div class="row">
                                <div class="col-md-6">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control @error('task') is-invalid @enderror" name="task" value="{{ old('task') }}">
                                        @error('task')
                                    ...
                                    @enderror
                                        <div class="col-md">
                                            <div class="input-group mb-3">
                                                <input type="date" class="form-control @error('date_created') is-invalid @enderror" placeholder="Mulai" name="date_created" required>
                                                <span class="input-group-text">s/d</span>
                                                <input type="date" class="form-control @error('due_date') is-invalid @enderror" placeholder="Selesai" name="due_date" required>
                                            </div>
